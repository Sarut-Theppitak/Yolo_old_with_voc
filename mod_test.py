...
class Tester(object):
    def __init__(self,
        ...
        self.__model = Yolov3(cfg, deploy=True).to(self.__device)
        # self.__model = Yolov3(cfg).to(self.__device)

        self.__load_model_weights(use_weight_path)

        # self.__evalter = VocEvaluator(self.__model, cfg, mode="test", visiual=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_weight_path', type=str, default='./weight/aws_100_epoch/best_deploy.pt', help='weight file path')
