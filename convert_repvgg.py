...
# train_state_dict = torch.load('./weight/pre_weight_voc_repA1g4/best.pt')
...
# torch.save(deploy_state_dict, './weight/pre_weight_voc_repA1g4/best_deploy.pt')
...
deploy_state_dict = torch.load('./weight/pre_weight_voc_repA1g4/best_deploy.pt')
deploy_model = Yolov3(cfg=cfg, deploy=True)
