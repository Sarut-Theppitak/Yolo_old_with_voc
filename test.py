...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_path', type=str, default='weight/lw_movb2_fp_nopretrain03Feb2021/best.pt', help='weight file path')
    parser.add_argument('--visiual', type=str, default='./test_data/test/images', help='test data path or None')
